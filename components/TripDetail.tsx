                        ...
                        <div className="flex flex-col gap-4 mt-2 bg-sky-50 border border-sky-100 rounded-xl p-4">
                          ...
                          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            {trip.locations.map((location) => (
                              <div
                                key={location.id}
                                className="flex items-center gap-2 p-4 bg-white/80 rounded-lg shadow-sm border border-gray-100"
                              >
                ...
                {trip.locations.length > 0 ? (
                  <div className="space-y-4">
                    ...
                    {trip.locations.map((location) => (
                      <div
                        key={location.id}
                        className="flex items-center gap-4 p-4 bg-white/90 backdrop-blur-md rounded-lg shadow hover:shadow-lg transition-shadow"
                      >
                  ...
                  <div className="text-gray-500">
                    ...
                    <p className="text-gray-500 mb-6 max-w-md">
                      Start building your trip by adding locations to your
                      itinerary
                    </p>
                    <Link
                      href={`/trips/${trip.id}/itinerary/new`}
