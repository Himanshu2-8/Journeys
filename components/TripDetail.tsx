...
import { Calendar, Plus, MapPin, Clock, CalendarDays, Home, Map, List, PlusCircle } from "lucide-react"
                ...
                <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                        <Link 
                            ...
                            className="bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 border border-white/20 flex items-center gap-3 hover:bg-white"
                        >
                            <div className="p-2 bg-sky-100 rounded-lg text-sky-600">
                                <PlusCircle className="w-6 h-6" />
                            </div>
                            <div>
                                <h3 className="font-semibold text-sky-800">Add Location</h3>
                                <p className="text-sm text-gray-500">Add places to your itinerary</p>
                            </div>
                        </Link>
                        <div className="bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/20 flex items-center gap-3">
                            <div className="p-2 bg-amber-100 rounded-lg text-amber-600">
                                <MapPin className="w-6 h-6" />
                            </div>
                            <div>
                                <h3 className="font-semibold text-sky-800">View on Map</h3>
                                <p className="text-sm text-gray-500">See all locations on a map</p>
                            </div>
                        </div>
                        <div className="bg-white/90 backdrop-blur-md p-4 rounded-xl shadow-lg border border-white/20 flex items-center gap-3">
                            ...
                            <div>
                                <h3 className="font-semibold text-sky-800">Accommodations</h3>
                                <p className="text-sm text-gray-500">Manage your stays</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <Tabs value={activeTab} onValueChange={setActiveTab}>
                                        ...
                                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                            ...
                                            <Card className="border-0 shadow-sm">
                                                ...
                                                <CardContent className="space-y-3">
                                                    ...
                                                    <button className="flex items-center gap-3 p-3 rounded-lg hover:bg-sky-50 transition-colors w-full text-left">
                            ...
                            <TabsContent value="map" className="p-6">
                                <div className="flex flex-col items-center justify-center py-12 text-center">
                                    ...
                                    <p className="text-gray-500 mb-6 max-w-md">Add locations to your trip to see them on the map</p>
                                    <Link 
                                        href={`/trips/${trip.id}/itinerary/new`}
                                        className="inline-flex items-center gap-2 px-4 py-2 bg-sky-600 hover:bg-sky-700 text-white rounded-lg transition-colors"
                                    >
